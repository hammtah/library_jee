...
<header class="page-header">
    <div class="page-header-inner">
        ...
        <div class="actions">
            ...
            <a href="${pageContext.request.contextPath}/update?id=${b.id}" class="btn primary">Edit Book</a>
        </div>
    </div>
</header>
    ...
    <div class="card">
        <div class="form-grid">
            ...
            <aside class="panel">
                ...
                <div class="field">
                    <div class="cover-uploader" aria-label="Book cover">
                        <div class="cover-preview" id="coverPreview">
                            ...
                            <div class="cover-placeholder" id="coverPlaceholder">
                                ...
                                <div class="helper">Direct link provided by the database</div>
                            </div>
                        </div>
                        <input id="imgUrl" name="img" type="url" placeholder="https://example.com/book-cover.jpg" value="${empty b.img ? 'https://example.com/cover.jpg' : b.img}" readonly>
                    </div>
                </div>
            </aside>
            ...
            <section class="form">
                ...
                <div class="section">
                    <div class="field">
                        ...
                        <input id="title" name="title" type="text" value="${b.title}" readonly>
                    </div>
                    <div class="field">
                        <label for="author">Author</label>
                        <input id="author" name="author" type="text" value="${b.author}" readonly>
                    </div>
                </div>
                ...
                <div class="section">
                    <div class="field">
                        ...
                        <input id="isbn" name="isbn" type="text" value="${b.isbn}" readonly>
                    </div>
                    <div class="field">
                        <label for="genre">Genre</label>
                        <input id="genre" name="genre" type="text" value="${b.genre}" readonly>
                    </div>
                </div>
                ...
                <div class="section">
                    <div class="field">
                        ...
                        <input id="year" name="year" type="number" value="${b.year}" readonly>
                    </div>
                    <div class="field">
                        <label for="price">Price ($)</label>
                        <input id="price" name="price" type="number" step="0.01" value="${b.price}" readonly>
                    </div>
                </div>
                ...
                <div class="section full">
                    <div class="field">
                        ...
                        <textarea id="description" name="description" maxlength="2000" readonly>${b.description}</textarea>
                    </div>
                </div>
...
(function () {
    ...
    // Ensure the preview and counter reflect server-provided values on initial load
    window.addEventListener('DOMContentLoaded', function () {
        updateCoverFromUrl();
        updateCounter();
    });
